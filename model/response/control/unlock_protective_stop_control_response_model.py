...
class UnlockProtectiveStopControlResponseModel(ResponseModel):
    def __init__(self):
        super().__init__()
        self._robot_mode = None
        self._robot_status = None
        self._robot_safety_status = None
    ...
    @property
    def robot_safety_status(self):
        return self._robot_safety_status
    ...
    @robot_safety_status.setter
    def robot_safety_status(self, value):
        self._robot_safety_status = value
    ...
    def get(self):
        ...
        return {
            ...
            "robot_safety_status": self.robot_safety_status,
        }
