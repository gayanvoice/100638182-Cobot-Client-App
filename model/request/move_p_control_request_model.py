...
class MovePControlRequestModel:
    ...
    def get_move_p_control_request_model_from_values(values):
        ...
        move_p_control_request_model.acceleration = data["acceleration"]
        move_p_control_request_model.velocity = data["velocity"]
        move_p_control_request_model.blend_radius = data["blend_radius"]
        for joint_position_model_array_object in data["joint_position_model_array"]:
            ...
            move_p_control_request_model.joint_position_model_array = joint_position_model
